...
<?php $__env->startSection('title', $__t('Stores')); ?>
		...
		<div class="title-related-links">
			...
			<div class="related-links collapse d-md-flex order-2 width-xs-sm-100"
				...
				<a class="btn btn-primary responsive-button m-1 mt-md-0 mb-md-0 float-right show-as-dialog-link"
					href="<?php echo e($U('/shoppinglocation/new?embedded')); ?>">
					<?php echo e($__t('Add')); ?>

				</a>
				<a class="btn btn-outline-secondary m-1 mt-md-0 mb-md-0 float-right"
					href="<?php echo e($U('/userfields?entity=shopping_locations')); ?>">
	...
	<div class="col">
		<table id="shoppinglocations-table"
			...
			<tbody class="d-none">
				...
				<tr class="<?php if($shoppinglocation->active == 0): ?> text-muted <?php endif; ?>">
					<td class="fit-content border-right">
						<a class="btn btn-info btn-sm show-as-dialog-link"
							href="<?php echo e($U('/shoppinglocation/')); ?><?php echo e($shoppinglocation->id); ?>?embedded"
							data-toggle="tooltip"
						...
						<a class="btn btn-danger btn-sm shoppinglocation-delete-button"
							href="#"
							data-shoppinglocation-id="<?php echo e($shoppinglocation->id); ?>"
							data-shoppinglocation-name="<?php echo e($shoppinglocation->name); ?>"
							data-toggle="tooltip"
					...
					<td>
						<?php echo e($shoppinglocation->name); ?>

					</td>
					<td>
						<?php echo e($shoppinglocation->description); ?>
...
<?php echo $__env->make('layout.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/www/views/shoppinglocations.blade.php ENDPATH**/ ?>